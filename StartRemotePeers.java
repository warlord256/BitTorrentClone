...
private static final String scriptPrefix = "cd FileTorrent; java peerProcess ";
...
String ciseUser = "vravi"; // change with your CISE username
...
*/
jsch.addIdentity("/cise/homes/vravi/.ssh/id_rsa", "");
...
//((ChannelExec) channel).setCommand("cd 1002; java peerProcess ");
